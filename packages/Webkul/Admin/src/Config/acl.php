...
return [
    [
        ...
        'name'  => 'admin::app.acl.create',
        'route' => ['admin.leads.sdr.create', 'admin.leads.sdr.store', 'admin.leads.sdr.services_offered.store'],
        'sort'  => 1,
    ], [
        'key'   => 'sdr_leads.view',
        'name'  => 'admin::app.acl.view',
        'route' => 'admin.leads.sdr.view',
        'sort'  => 2,
    ], [
        'key'   => 'sdr_leads.edit',
        'name'  => 'admin::app.acl.edit',
        'route' => [
            'admin.leads.sdr.edit',
            'admin.leads.sdr.form_data',
            'admin.leads.sdr.update',
            'admin.leads.sdr.mass_update',
            'admin.leads.sdr.tags.attach',
            'admin.leads.sdr.tags.replace',
            'admin.leads.sdr.tags.detach',
            'admin.leads.sdr.services_offered.store',
            'admin.leads.sdr.attributes.update',
            'admin.leads.sdr.stage.update',
        ],
        'sort'  => 3,
    ], [
        'key'   => 'sdr_leads.delete',
        'name'  => 'admin::app.acl.delete',
        'route' => ['admin.leads.sdr.delete', 'admin.leads.sdr.mass_delete'],
        'sort'  => 4,
    ], [
        'key'   => 'sdr_leads.import',
        'name'  => 'admin::app.acl.import',
        'route' => [
            'admin.leads.sdr.import',
            'admin.leads.sdr.import.start',
            'admin.leads.sdr.import.process',
            'admin.leads.sdr.import.retry',
            'admin.leads.sdr.import.template',
        ],
        'sort'  => 5,
    ], [
        'key'   => 'sdr_leads.disqualified',
        'name'  => 'admin::app.acl.disqualified-leads',
        'route' => [
            'admin.leads.sdr.disqualified',
            'admin.leads.sdr.restore_disqualified',
            'admin.leads.sdr.incorrect_info.reassign',
            'admin.leads.sdr.ended.reassign',
            'admin.leads.sdr.disqualify',
        ],
        'sort'  => 6,
    ], [
        'key'   => 'lge_leads',
