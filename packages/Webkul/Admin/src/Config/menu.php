...
return [
    ...
    [
        ...
        'name'       => 'admin::app.layouts.industries',
        'info'       => 'admin::app.layouts.industries-info',
        'route'      => 'admin.settings.industries.index',
        'sort'       => 4,
        'icon-class' => 'icon-settings-type',
    ], [
        'key'        => 'settings.lead.services_offered',
        'name'       => 'admin::app.layouts.services-offered',
        'info'       => 'admin::app.layouts.services-offered-info',
