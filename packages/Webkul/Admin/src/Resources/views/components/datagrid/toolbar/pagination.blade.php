        ...
        >
            ...
            <template v-else>
                <div class="flex items-center gap-x-2">
                    ...
                    <select
                        class="custom-select w-[4.5rem] cursor-pointer rounded-md border border-gray-200 py-1.5 pl-2.5 pr-8 text-sm leading-6 text-gray-600 transition-all hover:border-gray-400 focus:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-400 dark:focus:border-gray-400"
                        :value="applied.pagination.perPage"
                        @change="changePerPageOption(Number($event.target.value))"
                    >
                        <option
