...
return [
    'acl' => [
        ...
        'leads-sdr'        => 'SDR Leads',
        'leads-lge'        => 'LGE Leads',
        'leads-lead-clouser' => 'Lead Clouser Leads',
        'lead'             => 'Lead',
        'quotes'           => 'Quotes',
        'mail'             => 'Mail',
        'inbox'            => 'Inbox',
        ...
        'dashboard-lead-clouser' => 'Lead Clouser Dashboard',
        'dashboard-lge'    => 'LGE Dashboard',
    ...
    'settings' => [
        ...
        'deleted-leads' => [
            'index' => [
                ...
                'permanent-delete-success' => 'Lead permanently deleted successfully.',
                'restore-success'          => 'Lead restored successfully.',
                'title'                    => 'Deleted Leads',
        ...
        'sources' => [
            'index' => [
                ...
                'create' => [
                    ...
                    'title'                      => 'Create Source',
                    'sub-sources'                => 'Sub-Sources',
                    'sub-source-name'            => 'Enter sub-source name',
                    'add-btn'                    => 'Add',
                    'sub-sources-info'           => 'Add sub-sources by typing a name and clicking Add.',
                    'existing-sub-sources'       => 'Select from Existing Sub-Sources',
                    'no-existing-sub-sources'    => 'No existing sub-sources available.',
                ],
    ...
    'activities' => [
        ...
        'notifications' => [
            ...
            'marked-all-done' => 'All notifications marked as read.',
            'marked-done' => 'Notification marked as read.',
            'view-all'    => 'View all activities',
            'lead'        => 'Lead',
            'due'         => 'Due',
        ],
    ...
    'leads' => [
        ...
        'disqualified-success'      => 'Lead marked as :reason and removed from SDR queues.',
        'restored-success'          => 'Lead restored to SDR queues.',
        'disqualification'          => [
            'page-title'             => 'DNC, Incorrect Info & Ended Leads',
            'short-title'            => 'DNC / Incorrect / Ended',
            'status'                 => 'Record Status',
            'do-not-call'            => 'Do Not Call',
            'incorrect-info'         => 'Incorrect Info',
            'ended'                  => 'Ended Leads',
            'dnc-info'               => 'Permanent do-not-call records for admin review.',
            'incorrect-info-info'    => 'Correct these records and reassign them back to the team.',
            'ended-info'             => 'Leads ended by SDRs. Review the comment and reassign when they should return to the team.',
            'comment'                => 'Comment',
            'comment-placeholder'    => 'Add the reason or details for admin review.',
            'comment-required'       => 'Please add a comment before continuing.',
            'restore'                => 'Restore for SDR',
            'back-to-leads'          => 'Back to Leads',
            'view'                   => 'View',
            'owner'                  => 'Owner',
            'source'                 => 'Source',
            'marked-at'              => 'Marked At',
            'no-dnc'                 => 'No Do Not Call leads found.',
            'no-incorrect-info'      => 'No Incorrect Info leads found.',
            'no-ended'               => 'No Ended leads found.',
            'reassign-to'            => 'Reassign To',
            'select-user'            => 'Select user',
            'correct-reassign'       => 'Reassign',
            'reassigned-success'     => 'Lead reassigned successfully.',
            'reassign-invalid'       => 'This lead is not available for reassignment here.',
            'confirm-do-not-call'    => 'Mark this lead as Do Not Call?',
            'confirm-incorrect-info' => 'Mark this lead as Incorrect Info?',
        ],
        'replicate'                 => [
        ...
        'index' => [
            ...
            'datagrid' => [
                ...
                'followup-count'      => 'Follow-up Count',
                'last-followup-date'  => 'Last Follow-up',
                'created-at'          => 'Created At',
                'no'                  => 'No',
                'yes'                 => 'Yes',
                'delete'              => 'Delete',
            ...
            'kanban' => [
                ...
                'toolbar' => [
                    ...
                    'sort' => [
                        ...
                        'newest-first-desc'     => 'Most recent leads at the top',
                        'oldest-first'          => 'Oldest First',
                        'oldest-first-desc'     => 'Oldest leads at the top',
                        'value-high-low'        => 'Value: High to Low',
                        'value-high-low-desc'   => 'Highest value leads first',
                        'value-low-high'        => 'Value: Low to High',
                        'value-low-high-desc'   => 'Lowest value leads first',
                        'title-az'              => 'Title: A-Z',
                        'title-az-desc'         => 'Alphabetical order',
                        'title-za'              => 'Title: Z-A',
                        'title-za-desc'         => 'Reverse alphabetical order',
                    ],
                ],
            ],
        ...
        'view' => [
            ...
            'persons' => [
                ...
                'empty-message' => 'Contact information will be added soon',
                'empty-hint'    => 'Click the edit icon above to add contact details when available',
            ],
